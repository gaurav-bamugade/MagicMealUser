...
class SnacksActivity : AppCompatActivity() {
    ...
    override fun onCreate(savedInstanceState: Bundle?) {
        ...
        val retData = fStore.collection("MagicMealAdmin").document(adminID).collection("Snacks")
                ...
                for (i in snap.documentChanges) {
                    if (i.document.exists()) {
                        try {
                            ...
                            Log.d("foodnam", i.document.getString("foodname").toString())
        ...
        recylerView = findViewById(R.id.recyler_view_snacks)
